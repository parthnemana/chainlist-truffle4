...
contract('ChainList', function(accounts){
  ...
  it("should let us sell a second article", function(){
   return ChainList.deployed().then(function(instance) {
     ...
     assert.equal(data[0].toNumber(), 1, "first article id must be 1");
     assert.equal(data[1].toNumber(), 2, "second article id must be 2");
  ...
  it("should buy an article", function(){
    return ChainList.deployed().then(function(instance) {
      ...
      assert.equal(data[0].toNumber(), 2, "article id left for sale must be 2");
