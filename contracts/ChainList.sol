...
contract ChainList is Ownable {
  ...
  //fetch article IDs for articles for sale
  function getArticlesForSale() public view returns(uint[]) {
    ...
    for(uint i = 1; i <= articleCounter; i++) {
      // keep the articleIDs if the article is for sale
    ...
    //copy the articleIds array into a smaller array of for sale articles
